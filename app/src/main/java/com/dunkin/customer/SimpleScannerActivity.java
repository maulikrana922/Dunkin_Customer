...
public class SimpleScannerActivity extends BackActivity implements ZXingScannerView.ResultHandler {
...
//    finish();
    ...
    public void setUpToolBar(String title) {
        ...
        if (toolBar != null) {
            toolBar.setTitleTextColor(ContextCompat.getColor(SimpleScannerActivity.this, android.R.color.white));

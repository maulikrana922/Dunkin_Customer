...
public class PromocodeWinStatusDialog extends DialogFragment {
    private ImageView imgStatus;
    private TextView tvOk;
    private LinearLayout llMain;
    private String strWinStatus, strStatusUrl,scanUrl;
    private static PromocodeWinStatusDialog f;
    private Context mContext;
    private int rotationCount = 0;

    public static PromocodeWinStatusDialog newInstance() {
        if (f == null) {
            f = new PromocodeWinStatusDialog();
        }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        imgStatus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                PromocodeWinStatusDialog.this.dismiss();

...
public class ImageFBDialog extends Dialog {
    private static ImageFBDialog f;
    ...
    public ImageFBDialog(Context context, String path) {
        super(context);
        this.mContext = context;
        this.path = path;
    }

    public ImageFBDialog(Context context, int themeResId, String path, boolean FromWhere) {
    ...
    public static ImageFBDialog newInstance(Context mContext, String imgPath, boolean FromWhere) {
        if (f == null) {
            int theme = R.style.LoadingDialog;
            f = new ImageFBDialog(mContext, theme/*android.R.style.Theme_Translucent_NoTitleBar_Fullscreen*/, imgPath, FromWhere);
        }
        return f;
    }
